...
const products = [
  {
    ...
    name: "Sambal Roa",
    description:
      "Sambal ikan roa khas Manado dengan cita rasa pedas gurih yang autentik. Dibuat dari ikan roa asap pilihan dan bumbu tradisional.",
    price: 48000,
  ...
  },
  {
    ...
    description:
      "Sambal ikan cakalang asap khas Manado dengan cita rasa yang kaya dan gurih. Perpaduan sempurna antara pedas dan gurih.",
    price: 45000,
  ...
  },
  {
    ...
    name: "Abon Tuna",
    description:
      "Abon tuna premium dengan tekstur lembut dan rasa yang gurih. Cocok untuk teman makan nasi atau roti.",
    price: 38000,
  ...
  },
  {
    ...
    name: "Kacang Batik",
    description:
      "Kacang tanah batik dengan bumbu khas yang renyah dan gurih. Camilan sempurna untuk berbagai momen.",
    price: 22000,
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // reset hash biar gak ganggu
  if (window.location.hash) {
    history.replaceState(null, null, " ");
  }

  showPage("home"); // paksa default ke home
});
...
function setupEventListeners() {
  ...
  document
    ...
    ?.addEventListener("click", () => showPage("account"));
  document
    .getElementById("cartBtn")
    ?.addEventListener("click", () => showPage("cart"));
...
function changeQuantity(delta) {
  ...
  productQuantity = Math.max(
    1,
    Math.min(product.stock, productQuantity + delta),
  );
...
function handleCheckout(e) {
  ...
  const order = {
    ...
    shippingCost: 15000,
    grandTotal:
      cart.reduce((sum, item) => sum + item.price * item.quantity, 0) + 15000,
...
function setupScrollEffects() {
  ...
  document
    .querySelectorAll(".product-card, .feature-card, .cart-item")
    .forEach((el) => {
      el.style.opacity = "0";
